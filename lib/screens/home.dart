...
import 'package:projeto_tudo_gostoso/models/recipe.dart';
import 'package:projeto_tudo_gostoso/screens/widgets/details.dart';
import 'package:projeto_tudo_gostoso/screens/widgets/list_elements.dart';
import 'package:projeto_tudo_gostoso/screens/widgets/my_title.dart';
import '../style.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // Faz a lista de modo de preparo da massa
            ListElements(
              title: "Massa",
              listOfElements: recipe.preparationModePaste,
            ),
            // Faz a lista de modo de preparo da cobertura
            ListElements(
              title: "Cobertura",
